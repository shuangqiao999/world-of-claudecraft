...
export const DICT: Record<string, Record<string, string>> = {
  en: {
    ...
    'time.day': '{count} day',
    'party.sameRegion': 'Players must be in the same region to form a party.',
  },
  en_CA: {
    'chat.filterMutedRemaining': "You are muted and can't chat for another {duration}.",
    'chat.filterMuted': "That language isn't allowed here. You're muted for {duration}.",
  ...
  es: {
    ...
    'time.day': '{count} día',
    'party.sameRegion': 'Los jugadores deben estar en la misma región para formar un grupo.',
  ...
  fr_FR: {
    ...
    'time.day': '{count} jour',
    'party.sameRegion': 'Les joueurs doivent être dans la même région pour former un groupe.',
  ...
  it_IT: {
    ...
    'party.sameRegion': 'I giocatori devono trovarsi nella stessa regione per formare un gruppo.',
  ...
  de_DE: {
    ...
    'time.day': '{count} Tag',
    'party.sameRegion':
      'Spieler müssen sich in derselben Region befinden, um eine Gruppe zu bilden.',
  ...
  zh_CN: {
    ...
    'time.days': '{count} 天',
    'time.day': '{count} 天',
    'party.sameRegion': '玩家必须在同一区域才能组建队伍。',
  ...
  zh_TW: {
    ...
    'time.days': '{count} 天',
    'time.day': '{count} 天',
    'party.sameRegion': '玩家必須在同一區域才能組建隊伍。',
  ...
  ko_KR: {
    ...
    'time.days': '{count}일',
    'time.day': '{count}일',
    'party.sameRegion': '파티를 구성하려면 플레이어가 같은 지역에 있어야 합니다.',
  ...
  ja_JP: {
    ...
    'time.days': '{count}日',
    'time.day': '{count}日',
    'party.sameRegion': 'パーティを組むにはプレイヤーが同じ地域にいる必要があります。',
  ...
  pt_BR: {
    ...
    'time.day': '{count} dia',
    'party.sameRegion': 'Os jogadores devem estar na mesma região para formar um grupo.',
  ...
  ru_RU: {
    ...
    'time.days': '{count} дн.',
    'time.day': '{count} дн.',
    'party.sameRegion': 'Игроки должны находиться в одном регионе, чтобы создать группу.',
